...
List<User> users = <User>[
  User(name: "Ema Watson", reaction: Reaction.thumbsUp),
  User(
    name: "Bill Jobs",
  ...
  User(
    ...
    bio:
        ...
        "TV Expert. Explorer. Travel Nerd. Incurable beer advocate.",
  ...
  User(name: "Lewis Hamilton", reaction: Reaction.thumbsDown),
  User(name: "Ana Camille", reaction: Reaction.thumbsUp),
];
